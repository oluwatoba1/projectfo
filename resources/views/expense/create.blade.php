...
@section('title')
    <a class="navbar-brand" href="#">Log Expense</a>
@endsection
                    ...
                    <div class="card">
                        ...
                        <div class="content">
                            @if(auth()->user()->role == 'supervisor')
                                <form action="/supervisor/expense" method="POST">

                            @elseif(auth()->user()->role == 'cashier')
                                <form action="/cashier/expense" method="POST">
                            @endif
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-info btn-fill btn-wd">Log Expense</button>
                                </div>
